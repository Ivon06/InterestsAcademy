    ...
    public partial class setup2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "080a469a-b5a2-44cc-a660-eea8e6fd05a5", 0, "ул. Ал. Стамболийски 30 ет.3 ап.11", new DateTime(2008, 4, 12, 13, 24, 0, 0, DateTimeKind.Unspecified), "Казанлък", "ca8bc7a3-7ac8-401d-a7e2-7637449221d1", "България", "petarpetrov@abv.bg", false, "Мъж", true, true, false, null, "Петър Петров", "PETARPETROV@ABV.BG", "PETAR", "AQAAAAIAAYagAAAAEGtXjBCgk3rXip5kPK62KONQ9jo+UbMwAELMbrz/bqS9UqqwrH+0l3E96k8EddpocA==", "0885763826", false, "https://res.cloudinary.com/ddriqreo7/image/upload/v1697607303/projectImages/xbhwflepot9qpwmiiq6u.jpg", new DateTime(2025, 2, 14, 18, 23, 43, 492, DateTimeKind.Utc).AddTicks(9447), "d0d8cba4-fe2f-40cb-8184-e8dc506ddb7b", false, "petar" },
                    { "20dcf707-dfd9-4aae-b8c3-f3b9844e09d8", 0, "ул. Незабравка 3", new DateTime(2015, 7, 18, 11, 20, 0, 0, DateTimeKind.Unspecified), "Енина", "59bb424c-9f94-4b6e-ac06-e98dac2e22ac", "България", "admin@abv.bg", false, "Мъж", true, true, false, null, "Admin", "ADMIN@ABV.BG", "ADMIN", "AQAAAAIAAYagAAAAEPXglqNDu5VI8Lv8rljHunnaWyitB15JHBXb/l780IL6DhVBWiYSoJL6XyU9NxKc4A==", "0889864842", false, "https://res.cloudinary.com/ddriqreo7/image/upload/v1697617373/projectImages/pyb6v86l6myou9h1sxca.jpg", new DateTime(2025, 2, 14, 18, 23, 43, 735, DateTimeKind.Utc).AddTicks(9512), "6a6cab15-fa6c-4a1c-8ad3-d26f329d9760", false, "Admin" },
                    { "93418f37-da3b-4c78-b0ae-8f0022b09681", 0, "ул.Възраждане 6 ет.2 ап.8", new DateTime(1968, 2, 8, 11, 20, 0, 0, DateTimeKind.Unspecified), "Казанлък", "5cce308a-d344-4043-94c7-32b4b6c34383", "България", "georgidimitrov@abv.bg", false, "Мъж", true, true, false, null, "Георги Димитров", "GEORGIDIMITROV@ABV.BG", "GEORGI", "AQAAAAIAAYagAAAAELWuG3v0Q88pvxsYYPf+8ujrZxMdd0n98OZy3eSRPIOFdb/diFuHThIsXwzzb1qh2Q==", "0885789826", false, "https://res.cloudinary.com/ddriqreo7/image/upload/v1697608565/projectImages/mvorrsshjbw1e8bzfzgq.jpg", new DateTime(2025, 2, 14, 18, 23, 43, 618, DateTimeKind.Utc).AddTicks(8093), "d7048da4-96f5-4967-baaf-df6ff21c7636", false, "georgi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "e6bb13af-fe1e-4276-b301-1bffe7f8c8fc", "Този курс обхваща основите на биологията – от клетките и ДНК до екосистемите и еволюцията. Ще разгледаме структурата и функциите на организмите, взаимодействията в природата и научните методи в биологията.", "2 месеца", true, true, "Биология", "64ae1f9e-bc59-4356-b74e-887f08425106", "2644afb5-f916-4b3f-b451-9ff86c881de3" });
        }
