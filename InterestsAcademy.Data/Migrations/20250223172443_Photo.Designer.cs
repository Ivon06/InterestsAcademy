...
namespace InterestsAcademy.Data.Migrations
{
    ...
    [Migration("20250223172443_Photo")]
    partial class Photo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InterestsAcademy.Data.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f1e469bc-af38-4208-84e1-2545b55fd55f",
            ...
            modelBuilder.Entity("InterestsAcademy.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Казанлък",
                            ConcurrencyStamp = "ba0937ed-a497-4ed8-98c8-01bf2a9bd9cd",
                            Country = "България",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMeTISPMQu9rxf4yJ31OBGGPT99y9ClNQsPN8DtjL4ntV5QA0fSIrWz1ESPXqKokFQ==",
                            ...
                            RegisteredOn = new DateTime(2025, 2, 23, 17, 24, 42, 388, DateTimeKind.Utc).AddTicks(273),
                            SecurityStamp = "a276b455-31a9-4be0-9140-dd8dbcbc9087",
                        ...
                        new
                        {
                            ...
                            City = "Казанлък",
                            ConcurrencyStamp = "4095e6e5-4dd8-4bb6-a727-d3074a8ac937",
                            Country = "България",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDrXyy+NE9pxRm4E9vpelWXSPFsiQmYhmpv+O5rKpwixeT8GcFlTl1WDOmdvfxK5/w==",
                            ...
                            RegisteredOn = new DateTime(2025, 2, 23, 17, 24, 42, 451, DateTimeKind.Utc).AddTicks(1538),
                            SecurityStamp = "9e7d2c31-f5cc-4097-a91d-40fc978d36b6",
                            TwoFactorEnabled = false,
                            UserName = "georgi"
                        },
                        new
                        {
                            ...
                            City = "Енина",
                            ConcurrencyStamp = "09b3dda4-b5f7-41f4-84fe-58e33bdb056e",
                            Country = "България",
                            Email = "admin@abv.bg",
                            EmailConfirmed = false,
                            Gender = "Мъж",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOV2jSvZOgI5uOfkwrkl+rJ/VlMm+I8413WTAeiSSGEY1yALtaGpeyyApNQ+MBrI0Q==",
                            ...
                            RegisteredOn = new DateTime(2025, 2, 23, 17, 24, 42, 509, DateTimeKind.Utc).AddTicks(436),
                            SecurityStamp = "20d1ad28-4348-4082-b4de-1418d80e1f72",
                            TwoFactorEnabled = false,
                            UserName = "Admin"
                        });
                });
