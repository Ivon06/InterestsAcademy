        ...
        private List<Course> GetCourse()
        {
            return new List<Course>()
            {
               new Course()
                ...
                Duration = "2 месеца",
                Description = "Този курс обхваща основите на биологията – от клетките и ДНК до екосистемите и еволюцията. Ще разгледаме структурата и функциите на организмите, взаимодействията в природата и научните методи в биологията.",
                IsActive = true,
                IsApproved = true,
                }
