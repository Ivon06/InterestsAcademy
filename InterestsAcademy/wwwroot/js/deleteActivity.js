...
//        let courseName = document.getElementById(`${e.id}-courseName`)/*.innerText*/;
//        let topic = document.getElementById(`${e.id}-topic`).innerText;

//        form.innerHTML = `<input type="hidden" name="topic" value="${topic}" />`
//        form.innerHTML += `<input type="hidden" name="courseName" value="${courseName}" />`
...
//        btn.addEventListener('submit', deleteMeeting);
//        btn.id = `delete-${e.id}`;
